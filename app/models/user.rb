class User < ActiveRecord::Base
  ...
  def create_status_sms
    ...
    active_goals_summary = "DontBLazy Bot: Reply 1 to check-in first goal. 2 to check in second. Check in multiple goals with comma seperated numbers, like this = 1,2,3. Upcoming Goals:" + active_goals
  end
