class User < ActiveRecord::Base
  ...
  def create_status_sms
    ...
    active_goals_summary = "Reply 1 to check-in first goal. Reply 2 to check-in second. To check-in multiple, seperate numbers by a comma. Like this = 1,2,3:" + active_goals
  end
